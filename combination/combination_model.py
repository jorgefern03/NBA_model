...
rfe_selector1 = RFE(estimator=LogisticRegression(max_iter=100000), step = 50, n_features_to_select=0.65)
...
for i in range(0, 12):
    retrain = matriz_pred_c.shape[0] // 12
    step = i
